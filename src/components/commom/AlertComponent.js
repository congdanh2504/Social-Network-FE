...
export default function AlertComponent({ status, message }) {
    return (
        <div id={status} class="flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
