...
export default function UserCard({ title, user }) {
    return (
        <div class="relative h-[400px] mt-[15px] max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700  ">
            ...
            <div class="absolute mt-[70px] z-10 flex flex-col items-center w-full pb-10">
