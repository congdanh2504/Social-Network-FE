...
<<<<<<< HEAD
        user && <div className='header-top-right w-[300px] flex flex-row justify-end gap-[10px] items-center mr-[15px]'>
            <div className='flex flex-row h-[40px] items-center px-[3px] hover:bg-[#1890FF] hover:text-white rounded-[30px] cursor-pointer'>
            ...
            <div className='w-[40px] h-[40px] rounded-full bg-gray-300 flex items-center justify-center cursor-pointer hover:bg-[#1890FF] hover:fill-white'>
