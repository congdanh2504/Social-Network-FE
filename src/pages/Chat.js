    ...
    return (
        <div className="flex flex-col h-[100vh]">
            ...
            <div className="border rounded flex flex-1">
                <div className="border-r border-gray-300 w-[400px] h-full">
                    ...
                    <ul className="overflow-auto">
                        <h2 className="my-2 mb-2 ml-2 text-lg text-gray-600 font-bold">Conversations</h2>
                        <li>
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    {emojiClose && <Picker pickerStyle={{ width: '100%' }} />}
                </div>
            </div>
        </div>
    )
